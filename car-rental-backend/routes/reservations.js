...
router.post('/', async (req, res) => {
  try {
    const reservation = await reservationsService.create(req.body.id, req.body.customerId,req.body.carId,req.body.startDate,req.body.endDate,req.body.totalPrice,req.body.status,req.body.paymentDetails);
