...
interface AdminReservationsTableDateProps {
  specificDate: any[]; // Adjust the type based on your actual response structure
}

const AdminReservationsTableDate: React.FC<AdminReservationsTableDateProps> = ({
  specificDate,
}) => {
  return (
...
export default AdminReservationsTableDate;
